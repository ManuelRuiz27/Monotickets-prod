const ACTIONS = Object.freeze({
  ...
  DIRECTOR_REPORTS_OVERVIEW: 'director:reports:overview',
  DIRECTOR_REPORTS_TOP: 'director:reports:topOrganizers',
  DIRECTOR_REPORTS_DEBT: 'director:reports:debtAging',
  DIRECTOR_REPORTS_USAGE: 'director:reports:ticketsUsage',
...
const ROLE_PERMISSIONS = new Map([
  [
    ...
    new Set([
      ...
      ACTIONS.DIRECTOR_REPORTS_OVERVIEW,
      ACTIONS.DIRECTOR_REPORTS_TOP,
      ACTIONS.DIRECTOR_REPORTS_DEBT,
      ACTIONS.DIRECTOR_REPORTS_USAGE,
    ]),
  ],
  ['admin', new Set(['*'])],
  [
